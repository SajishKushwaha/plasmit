...
export const mockRoles: AdminRoleRecord[] = [
  ...
  { id: "role-icu", name: "ICU", type: "System", description: "ICU command center, critical care, handover, device, analytics, and patient workflow access.", departmentScope: "ICU Command", status: "Active", userCount: 18, modulesAllowed: 1, permissionCount: 34, protected: true, risk: "High", updatedAt: "Today 14:30" },
...
export const mockDepartments: DepartmentRecord[] = [
  { id: "dept-card", code: "CARD", name: "Cardiology", type: "Clinical", head: "Dr. Kavita Rao", location: "Tower A, Floor 3", users: 42, status: "Active", enabledWorkflows: ["OPD", "IPD", "Billing", "Appointment"], branch: "Plasmit Main Hospital", floor: "Floor 3", roomWing: "Tower A", contactNumber: "+91 20 4000 2301", email: "cardiology@plasmit.care", totalDoctors: 12, assignedDoctorIds: ["doc-001"], opdTiming: "09:00-20:00", workingDays: "Mon-Sat", emergencyAvailable: true, emergencyContactDoctor: "Dr. Kavita Rao", patientCapacityPerDay: 140, servicesOffered: ["ECG", "Echo", "Cardiac OPD"], feeRange: "₹700-₹1,600", linkedServices: ["Lab", "Radiology"] },
  { id: "dept-emrg", code: "EMRG", name: "Emergency", type: "Clinical", head: "Dr. Aman Verma", location: "Ground Floor", users: 58, status: "Active", enabledWorkflows: ["Emergency", "Billing", "Ambulance"], branch: "Plasmit Main Hospital", floor: "Ground Floor", roomWing: "Emergency Wing", contactNumber: "+91 20 4000 2200", email: "emergency@plasmit.care", totalDoctors: 18, assignedDoctorIds: ["doc-002"], opdTiming: "24x7", workingDays: "All days", emergencyAvailable: true, emergencyContactDoctor: "Dr. Aman Verma", patientCapacityPerDay: 220, servicesOffered: ["Triage", "Trauma", "Casualty"], feeRange: "₹500-₹1,800", linkedServices: ["Ambulance", "Radiology", "Lab"] },
  { id: "dept-lab", code: "LAB", name: "Central Laboratory", type: "Diagnostic", head: "Dr. Neha Malik", location: "Tower B, Floor 1", users: 34, status: "Active", enabledWorkflows: ["LIS", "Billing", "Reports"], branch: "Plasmit Main Hospital", floor: "Floor 1", roomWing: "Tower B", contactNumber: "+91 20 4000 2401", email: "lab@plasmit.care", totalDoctors: 6, assignedDoctorIds: ["doc-003"], opdTiming: "10:00-17:00", workingDays: "Mon-Sat", emergencyAvailable: false, emergencyContactDoctor: "Dr. Neha Malik", patientCapacityPerDay: 300, servicesOffered: ["Hematology", "Biochemistry", "Microbiology"], feeRange: "₹300-₹1,200", linkedServices: ["OPD", "IPD"] },
  { id: "dept-rad", code: "RAD", name: "Radiology", type: "Diagnostic", head: "Dr. Sameer Khan", location: "Tower B, Floor 2", users: 27, status: "Active", enabledWorkflows: ["RIS", "PACS", "Billing"], branch: "Plasmit Main Hospital", floor: "Floor 2", roomWing: "Tower B", contactNumber: "+91 20 4000 2501", email: "radiology@plasmit.care", totalDoctors: 8, assignedDoctorIds: ["doc-004"], opdTiming: "08:00-20:00", workingDays: "Mon-Sat", emergencyAvailable: true, emergencyContactDoctor: "Dr. Sameer Khan", patientCapacityPerDay: 180, servicesOffered: ["X-ray", "CT", "MRI", "Ultrasound"], feeRange: "₹600-₹2,500", linkedServices: ["PACS", "Emergency"] },
  { id: "dept-fin", code: "FIN", name: "Billing & Finance", type: "Finance", head: "Meera Sinha", location: "Admin Block", users: 19, status: "Active", enabledWorkflows: ["OPD Billing", "IPD Billing", "Insurance"], branch: "Plasmit Main Hospital", floor: "Admin Floor", roomWing: "Finance Block", contactNumber: "+91 20 4000 2601", email: "finance@plasmit.care", totalDoctors: 0, assignedDoctorIds: [], opdTiming: "Not applicable", workingDays: "Mon-Sat", emergencyAvailable: false, emergencyContactDoctor: "Not applicable", patientCapacityPerDay: 0, servicesOffered: ["Billing", "Insurance", "TPA"], feeRange: "Not applicable", linkedServices: ["OPD Billing", "IPD Billing"] },
  { id: "dept-store", code: "STORE", name: "Central Store", type: "Store", head: "Rakesh Yadav", location: "Basement", users: 12, status: "Inactive", enabledWorkflows: ["Purchase", "GRN", "Stock Audit"], branch: "Plasmit Main Hospital", floor: "Basement", roomWing: "Store Bay", contactNumber: "+91 20 4000 2701", email: "store@plasmit.care", totalDoctors: 0, assignedDoctorIds: [], opdTiming: "Not applicable", workingDays: "Mon-Sat", emergencyAvailable: false, emergencyContactDoctor: "Not applicable", patientCapacityPerDay: 0, servicesOffered: ["Inventory", "GRN", "Stock Audit"], feeRange: "Not applicable", linkedServices: ["Inventory"] },
];
...
export const mockUsers: UserRecord[] = [
  ...
  { id: "user-008", employeeCode: "EMP-1190", name: "Aman Verma", email: "aman.verma@plasmit.care", mobile: "+91 98220 55220", roleIds: ["role-icu"], departmentIds: ["dept-emrg"], designation: "ICU Command Coordinator", status: "Active", lastLoginAt: "Today 14:30", locked: false, failedLogins: 0 },
  { id: "user-007", employeeCode: "EMP-1192", name: "Priya Menon", email: "priya.menon@plasmit.care", mobile: "+91 98220 55221", roleIds: ["role-nurse-icu-2"], departmentIds: ["dept-emrg"], designation: "ICU 2 Staff Nurse", status: "Active", lastLoginAt: "Today 13:48", locked: false, failedLogins: 0 },
...
export const mockSecuritySessions: SecuritySession[] = [
  ...
  { id: "sess-004", user: "Priya Menon", role: "Nurse ICU 2", device: "Chrome on Nursing Station", ipAddress: "103.88.45.32", location: "Pune, IN", loginTime: "Today 13:48", lastActivity: "Now", status: "Active" },
  { id: "sess-005", user: "Aman Verma", role: "ICU", device: "Chrome on ICU Command Desk", ipAddress: "103.88.45.33", location: "Pune, IN", loginTime: "Today 14:30", lastActivity: "Now", status: "Active" },
