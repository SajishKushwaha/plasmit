...
export const mockRoles: AdminRoleRecord[] = [
  ...
  { id: "role-nurse-icu-2", name: "Nurse ICU 2", type: "System", description: "ICU command center and dedicated Nursing ICU workflow access.", departmentScope: "ICU 2", status: "Active", userCount: 24, modulesAllowed: 2, permissionCount: 25, protected: true, risk: "Medium", updatedAt: "Today 13:50" },
