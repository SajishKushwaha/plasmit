...
export type BillingDeskService = {
  ...
  name: string;
  category:
    "Pathology" | "Radiology" | "Package" | "Quick Test" | "Individual Test" | "Appointment";
  group: string;
  price: number;
  discount: number;
  tax: number;
...
function insuranceStatusForPatient(patient: PatientRecord): BillingDeskPatient["insuranceStatus"] {
  ...
  if (patient.abhaStatus === "Consent required" || patient.abhaStatus === "Link pending")
    return "Pending";
  return "Not required";
}
...
export const billingPatients: BillingDeskPatient[] = mockPatients.map(
  patientRecordToBillingPatient,
);
...
export const billingServices: BillingDeskService[] = [
  ...
  },
  {
    ...
    discount: 15,
    tax: 5,
    meta: "CBC, LFT, KFT, ECG, X-ray",
    includedServiceIds: ["svc-001", "svc-002", "svc-004", "svc-010"],
  },
  {
    id: "svc-008",
    ...
    discount: 10,
    tax: 5,
    meta: "Lipid, ECG, Echo screening",
    includedServiceIds: ["svc-002", "svc-010"],
  },
  {
    id: "svc-009",
...
export const billingReferrals: BillingReferral[] = [
  {
    ...
    source: "Doctor",
    organization: "Plasmit Cardiology OPD",
    commission: "0%",
    status: "No commission",
    notes: "Internal consultant, no referral payout.",
  },
  {
    id: "ref-002",
    doctor: "Dr. Harish Mehta",
    source: "Doctor",
    organization: "Mehta Clinic",
    commission: "8%",
    status: "Mapped",
    notes: "External OPD referral mapping active.",
  },
  {
    id: "ref-003",
    doctor: "Wellcare Corporate Desk",
    source: "Corporate",
    organization: "Wellcare Industries",
    commission: "Package contract",
    status: "Mapped",
    notes: "Corporate rate card applies before discount.",
  },
  {
    id: "ref-004",
    doctor: "Star Health TPA",
    source: "TPA",
    organization: "Star Health",
    commission: "Pre-auth",
    status: "Approval needed",
    notes: "Insurance requires pre-approval for high-value diagnostics.",
  },
  {
    id: "ref-005",
    doctor: "Community Health Camp",
    source: "Camp",
    organization: "Mayur Vihar Camp",
    commission: "5%",
    status: "Mapped",
    notes: "Camp referral discount can be applied once.",
  },
];
...
export const billingAppointments: BillingAppointment[] = [
  {
    ...
    room: "Consult Room 03",
  },
  {
    id: "apt-002",
    appointmentNo: "APT-5268",
    patientId: "pat-001",
    department: "Diagnostics Review",
    doctor: "Dr. Kavita Rao",
    slot: "Today 12:10 PM",
    visitType: "Review",
    status: "Scheduled",
  ...
  },
  {
    ...
    fee: 900,
    billingStatus: "Unbilled",
    room: "Consult Room 05",
  },
  {
    id: "apt-004",
    appointmentNo: "APT-5282",
    patientId: "pat-003",
