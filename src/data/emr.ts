...
export const mockRecordAccessAudit: RecordAccessAudit[] = [
  ...
  { id: "audit-004", patientId: "pat-003", recordId: "disc-003", recordType: "Disclosure request", user: "Reception", role: "Receptionlist", action: "Export package requested", reason: "Guardian request", sensitivity: "Consent-gated placeholder", ipAddress: "10.20.2.31", device: "Front desk", timestamp: "Yesterday 17:10", outcome: "Denied placeholder" },
