...
export type CvsParameterId =
  "heart-rate" | "temperature" | "bp-nibp" | "bp-arterial" | "cvp" | "pcwp";
...
export const cvsMetrics: CvsMetric[] = [
  {
    ...
    icon: HeartPulse,
    color: "#7367f0",
    sparkline: [82, 84, 83, 86, 85, 87, 86],
  },
  {
    id: "temperature",
    label: "Temperature",
    ...
    icon: Thermometer,
    color: "#3baed8",
    sparkline: [36.8, 37.0, 37.1, 37.2, 37.3, 37.2, 37.2],
  },
  {
    id: "bp-nibp",
    label: "BP NIBP",
    ...
    icon: Activity,
    color: "#22a06b",
    sparkline: [91, 92, 94, 93, 92, 93, 93],
  },
  {
    id: "bp-arterial",
    label: "BP Arterial Line",
    shortLabel: "Art BP",
    value: "118/76",
    unit: "mmHg",
    detail: "MAP 90",
    ...
    icon: Waves,
    color: "#5b8def",
    sparkline: [89, 90, 91, 90, 90, 91, 90],
  },
  {
    id: "cvp",
    label: "CVP",
  ...
  },
  {
    ...
    icon: Activity,
    color: "#2f80ed",
    sparkline: [11, 11, 12, 12, 13, 12, 12],
  },
];
...
export const cvsRecords: CvsRecord[] = [
  {
    ...
    cvp: 8,
    pcwp: 12,
    notes: "Awake, perfusion warm, no acute BP drop.",
  },
  {
    id: "cvs-002",
    ...
    cvp: 8,
    pcwp: 12,
    notes: "MAP maintained above target.",
  },
  {
    id: "cvs-003",
    ...
    cvp: 8,
    pcwp: 13,
    notes: "Low-grade temperature watch.",
  },
  {
    id: "cvs-004",
    ...
    cvp: 9,
    pcwp: 12,
    notes: "Transducer zeroed, waveform acceptable.",
  },
  {
    id: "cvs-005",
...
export const cvsParameterCards = [
  {
    id: "heart-rate",
    label: "Heart Rate",
    description: "Rhythm, source, and bedside notes",
    route: "/icu-monitoring/cvs/heart-rate",
    icon: HeartPulse,
  },
  {
    id: "temperature",
    label: "Temperature",
    description: "Temperature source, site, and notes",
    route: "/icu-monitoring/cvs/temperature",
    icon: Thermometer,
  },
  {
    id: "bp-nibp",
    label: "Blood Pressure - NIBP",
    description: "SBP, DBP, MAP, position, arm, cuff",
    route: "/icu-monitoring/cvs/bp-nibp",
    icon: Activity,
  },
  {
    id: "bp-arterial",
    label: "Blood Pressure - Arterial Line",
    description: "Line site, waveform, zeroing status",
    route: "/icu-monitoring/cvs/bp-arterial",
    icon: Waves,
  },
  {
    id: "cvp",
    label: "CVP",
    description: "Position, waveform, transducer state",
    route: "/icu-monitoring/cvs/cvp",
    icon: Stethoscope,
  },
  {
    id: "pcwp",
    label: "PCWP",
    description: "Pulmonary wedge pressure capture",
    route: "/icu-monitoring/cvs/pcwp",
    icon: Activity,
  },
];
...
export const abdominalMetrics: AbdominalMetric[] = [
  {
    ...
    icon: Gauge,
    color: "#7367f0",
    sparkline: [13, 14, 14, 13, 14, 15, 14],
  },
  {
    id: "ng-output",
    label: "NG Output Total",
    value: "850",
    unit: "ml / 24 hrs",
    ...
    icon: Droplets,
    color: "#3baed8",
    sparkline: [22, 30, 34, 38, 42, 48, 52],
  },
  {
    id: "gastrostomy-output",
    label: "Gastrostomy Output",
    value: "210",
    unit: "ml / 24 hrs",
    ...
    icon: Stethoscope,
    color: "#22a06b",
    sparkline: [8, 10, 9, 11, 10, 12, 13],
  },
  {
    id: "abdominal-drains",
    label: "Abdominal Drains Output",
    value: "640",
    unit: "ml / 24 hrs",
    ...
    icon: Activity,
    color: "#5b8def",
    sparkline: [24, 26, 28, 31, 32, 35, 36],
  },
];
...
export const abdominalChartConfigs = [
  ...
  {
    id: "gastrostomy-output",
    label: "Gastrostomy Output trend",
    latest: "13 ml/hr",
    total: "210 ml / 24 hrs",
    dataKey: "gastrostomyOutput",
    unit: "ml/hr",
    color: "#22a06b",
  },
  {
    id: "abdominal-drains",
    label: "Abdominal Drains Output trend",
    latest: "36 ml/hr",
    total: "640 ml / 24 hrs",
    dataKey: "abdominalDrains",
    unit: "ml/hr",
    color: "#5b8def",
  },
] as const;
...
export const abdominalComparisonRecords: AbdominalComparisonRecord[] = [
  {
    parameter: "Intra-abdominal Pressure",
    hourly: [13, 14, 14, 13, 14, 15, 14, 14],
    total12h: 168,
    total24h: 334,
  },
  {
    parameter: "NG Output",
    hourly: [28, 34, 38, 42, 48, 50, 52, 56],
    total12h: 568,
    total24h: 850,
  },
  {
    parameter: "Gastrostomy Output",
    hourly: [8, 10, 9, 11, 10, 12, 13, 13],
    total12h: 123,
    total24h: 210,
  },
  {
    parameter: "Abdominal Drains Output",
    hourly: [24, 26, 28, 31, 32, 35, 35, 36],
    total12h: 436,
    total24h: 640,
  },
];
...
export const drainTypes = [
  {
    ...
    icon: Droplets,
    description: "Surgical abdominal drain output and site review",
  },
  {
    id: "ng-tube",
    label: "NG Tube",
    icon: Stethoscope,
    description: "Drainage, feeding, residual, and position checks",
  },
  {
    id: "flexi-seal",
    label: "Flexi Seal",
    icon: Waves,
    description: "Stool output, leakage, and skin condition",
  },
  {
    id: "ileostomy",
    label: "Ileostomy",
    icon: Activity,
    description: "Stoma color, output type, and peristomal skin",
  },
  {
    id: "peg-tube",
    label: "PEG Tube",
    icon: Pill,
    description: "Feeding, residual, and blockage monitoring",
  },
  {
    id: "icc-chest-drain",
    label: "ICC Chest Drain",
    icon: Gauge,
    description: "Air leak, bubbling, and fluid type",
  },
  {
    id: "pericardial-drain",
    label: "Pericardial Drain",
    icon: HeartPulse,
    description: "Output volume and urgent increase review",
  },
  {
    id: "vac-dressing",
    label: "VAC Dressing",
    icon: Syringe,
    description: "Pressure, dressing integrity, and leakage",
  },
];
...
export const drainRecords: DrainRecord[] = [
  {
    id: "drain-abd-01",
    type: "Abdominal Drain",
    name: "Abdominal Drain",
    outputAmount: 180,
    outputUnit: "ml / 4 hrs",
    outputColor: "Serosanguinous",
    metadata: "RUQ site • Suction active",
    updatedAt: "10 min ago",
    status: "Monitor",
    icon: Droplets,
    color: "#d97706",
    sparkline: [28, 32, 36, 42, 48, 50, 54],
  },
  {
    id: "drain-ng-01",
    type: "NG Tube",
    ...
    outputUnit: "ml / shift",
    outputColor: "Bilious",
    metadata: "Drainage • Position verified",
    updatedAt: "18 min ago",
    status: "High Output",
    icon: Stethoscope,
    color: "#dc2626",
    sparkline: [34, 42, 46, 51, 56, 60, 66],
  },
  {
    id: "drain-flexi-01",
    type: "Flexi Seal",
    ...
    outputUnit: "ml / 4 hrs",
    outputColor: "Brown",
    metadata: "No leakage • Skin intact",
    updatedAt: "24 min ago",
    status: "Normal",
    icon: Waves,
    color: "#16a34a",
    sparkline: [14, 12, 13, 15, 14, 13, 12],
  },
  {
    id: "drain-ileo-01",
    type: "Ileostomy",
    ...
    outputAmount: 210,
    outputUnit: "ml / shift",
    outputColor: "Green-brown",
    metadata: "Stoma pink • Peristomal dry",
    updatedAt: "31 min ago",
    status: "Monitor",
    icon: Activity,
    color: "#d97706",
    sparkline: [24, 26, 28, 30, 34, 33, 35],
  },
  {
    id: "drain-peg-01",
    type: "PEG Tube",
    name: "PEG Tube",
    outputAmount: 35,
    outputUnit: "ml residual",
    outputColor: "Milky",
    metadata: "Feeding given • No blockage",
    updatedAt: "40 min ago",
    status: "Normal",
    icon: Pill,
    color: "#16a34a",
    sparkline: [8, 6, 7, 6, 5, 7, 6],
  },
  {
    id: "drain-icc-01",
    type: "ICC Chest Drain",
    name: "ICC (Chest Drain)",
    outputAmount: 120,
    outputUnit: "ml / 4 hrs",
    outputColor: "Serous",
    metadata: "No air leak • Mild bubbling",
    updatedAt: "12 min ago",
    status: "Monitor",
    icon: Gauge,
    color: "#d97706",
    sparkline: [18, 20, 22, 21, 24, 25, 24],
  },
  {
    id: "drain-peri-01",
    type: "Pericardial Drain",
    name: "Pericardial Drain",
    outputAmount: 70,
    outputUnit: "ml / hr",
    outputColor: "Blood stained",
    metadata: "Sudden increase flagged",
    updatedAt: "4 min ago",
    status: "Critical",
    icon: HeartPulse,
    color: "#dc2626",
    sparkline: [10, 12, 14, 18, 24, 42, 70],
  },
  {
    id: "drain-vac-01",
    type: "VAC Dressing",
    ...
    outputUnit: "ml / shift",
    outputColor: "Serous",
    metadata: "125 mmHg • Dressing intact",
  ...
  },
  {
    ...
    outputAmount: 540,
    outputUnit: "ml / shift",
    outputColor: "Clear yellow",
    metadata: "Dependent drainage • No kinks",
    updatedAt: "9 min ago",
    status: "Normal",
    icon: Droplets,
    color: "#16a34a",
    sparkline: [70, 72, 76, 74, 78, 80, 82],
  },
];
...
export const drainAlerts: DrainAlert[] = [
  {
    id: "alert-001",
    severity: "Critical",
    title: "Blood in pericardial drain",
    description: "Output changed to blood stained with sudden hourly increase.",
    timestamp: "4 min ago",
  },
  {
    id: "alert-002",
    severity: "Critical",
    title: "High output detected",
    description: "NG Tube output increased beyond configured ICU threshold.",
  ...
  },
  {
    ...
    description: "Flexi Seal leakage was reported during nursing review.",
    timestamp: "42 min ago",
  },
  {
    id: "alert-004",
    severity: "Monitor",
    title: "Stoma color change",
    description: "Ileostomy stoma color needs reassessment in next round.",
    timestamp: "1 hr ago",
  },
  {
    id: "alert-005",
    severity: "Monitor",
    title: "Possible blockage",
    description: "PEG residual output reduced compared with previous checks.",
    timestamp: "2 hr ago",
  },
  {
    id: "alert-006",
    severity: "Stable",
    title: "Dressing compromised ruled out",
    description: "VAC dressing integrity remains intact after review.",
    timestamp: "3 hr ago",
  },
];
...
export const lineDeviceTypes = [
  {
    id: "cvc",
    label: "CVC",
    fullName: "CVC (Central Venous Catheter)",
    icon: Stethoscope,
    description: "Central line lumen and blood return monitoring",
  },
  {
    id: "arterial-line",
    label: "Arterial Line",
    fullName: "Arterial Line",
    icon: Activity,
    description: "Waveform, zeroing, and dressing surveillance",
  },
  {
    id: "dialysis-line",
    label: "Dialysis Line",
    fullName: "Dialysis Line",
    icon: Gauge,
    description: "Arterial/venous lumen and flow safety",
  },
  {
    id: "foley-catheter",
    label: "Foley Catheter",
    fullName: "Foley Catheter",
    icon: Droplets,
    description: "Urine output, color, and drainage state",
  },
  {
    id: "ecmo-catheter",
    label: "ECMO Catheter",
    fullName: "ECMO Catheter",
    icon: HeartPulse,
    description: "Cannula, flow, dressing, anticoagulation",
  },
  {
    id: "picc-line",
    label: "PICC Line",
    fullName: "PICC Line",
    icon: Syringe,
    description: "PICC site, patency, and securement",
  },
  {
    id: "midline-catheter",
    label: "Midline Catheter",
    fullName: "Midline Catheter",
    icon: Syringe,
    description: "Midline access and dressing checks",
  },
  {
    id: "peripheral-iv-line",
    label: "Peripheral IV Line",
    fullName: "Peripheral IV Line",
    icon: Syringe,
    description: "Peripheral access monitoring",
  },
  {
    id: "chest-tube",
    label: "Chest Tube",
    fullName: "Chest Tube",
    icon: Waves,
    description: "Chest tube placement and drainage context",
  },
];
...
export const lineDeviceRecords: LineDeviceRecord[] = [
  {
    id: "line-cvc-01",
    type: "CVC",
    name: "CVC (Central Venous Catheter)",
    insertionDetails: "Inserted Today 06:30 • Day 1",
    site: "Right IJ",
    metadata: "Triple lumen • Dressing transparent",
    status: "Watch",
    icon: Stethoscope,
    color: "#d97706",
    sparkline: [72, 73, 72, 74, 75, 74, 76],
  },
  {
    id: "line-art-01",
    type: "Arterial Line",
    name: "Arterial Line",
    insertionDetails: "Inserted Yesterday 21:10 • Day 2",
    site: "Left radial",
    metadata: "Waveform crisp • Zeroed 16:00",
    status: "Active",
    icon: Activity,
    color: "#16a34a",
    sparkline: [88, 90, 91, 90, 92, 91, 93],
  },
  {
    id: "line-dialysis-01",
    type: "Dialysis Line",
    name: "Dialysis Line",
    insertionDetails: "Inserted 2 days ago • Day 3",
    site: "Right femoral",
    metadata: "Temporary catheter • Heparin locked",
    status: "Critical",
    icon: Gauge,
    color: "#dc2626",
    sparkline: [220, 210, 205, 196, 188, 178, 170],
  },
  {
    id: "line-foley-01",
    type: "Foley Catheter",
    name: "Foley Catheter",
    insertionDetails: "Inserted Today 08:00 • Day 1",
    site: "Urethral",
    metadata: "16 Fr • Dependent drainage",
    status: "Watch",
    icon: Droplets,
    color: "#d97706",
    sparkline: [46, 42, 38, 34, 31, 28, 25],
  },
  {
    id: "line-ecmo-01",
    type: "ECMO Catheter",
    name: "ECMO Catheter",
    insertionDetails: "Inserted 3 days ago • Day 4",
    site: "Femoral VA",
    metadata: "Flow 3.8 L/min • Dressing intact",
    status: "Active",
    icon: HeartPulse,
    color: "#16a34a",
    sparkline: [3.6, 3.7, 3.8, 3.8, 3.9, 3.8, 3.8],
  },
  {
    id: "line-picc-01",
    type: "PICC Line",
    name: "PICC Line",
    insertionDetails: "Inserted 5 days ago • Day 6",
    site: "Right basilic",
    metadata: "Single lumen • Securement intact",
    status: "Active",
    icon: Syringe,
    color: "#16a34a",
  ...
  {
    id: "line-mid-01",
    type: "Midline Catheter",
    name: "Midline Catheter",
    insertionDetails: "Inserted 4 days ago • Day 5",
    site: "Left cephalic",
    metadata: "Dressing clean • Flush due",
    status: "Active",
    icon: Syringe,
    color: "#16a34a",
    sparkline: [1, 1, 1, 1, 1, 1, 1],
  ...
  {
    id: "line-piv-01",
    type: "Peripheral IV Line",
    name: "Peripheral IV Line",
    insertionDetails: "Inserted Today 12:20 • Day 1",
    site: "Left hand",
    metadata: "22G • Mild redness watch",
    status: "Watch",
    icon: Syringe,
    color: "#d97706",
  ...
  },
  {
    ...
    type: "Chest Tube",
    name: "Chest Tube",
    insertionDetails: "Inserted Yesterday 09:45 • Day 2",
    site: "Right pleural",
    metadata: "Water seal • No air leak",
    status: "Active",
    icon: Waves,
    color: "#16a34a",
    sparkline: [26, 24, 23, 21, 20, 18, 18],
  },
];
...
export const lineDeviceAlerts: LineDeviceAlert[] = [
  {
    id: "ld-alert-001",
    severity: "Critical",
    title: "No blood return",
    description: "White lumen has no blood return and is marked blocked.",
    timestamp: "8 min ago",
  },
  {
    id: "ld-alert-002",
    severity: "Critical",
    title: "Low flow dialysis line",
    description: "Dialysis flow reduced below ICU threshold.",
    timestamp: "18 min ago",
  },
  {
    id: "ld-alert-003",
    ...
    description: "Arterial pressure trend requires reassessment.",
  ...
  },
  {
    ...
    description: "Foley catheter urine output below configured threshold.",
  ...
  },
  {
    ...
    severity: "Monitor",
    title: "Dressing leak",
    description: "Peripheral IV dressing requires review.",
    timestamp: "1 hr ago",
  },
  {
    id: "ld-alert-006",
    severity: "Stable",
    title: "Site infection risk stable",
    description: "CVC site remains clean after latest dressing review.",
    timestamp: "2 hr ago",
  },
];
