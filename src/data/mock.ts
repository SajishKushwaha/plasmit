...
export const dashboardStats = [
  {
    ...
    context: "Today across 9 departments",
  },
  {
    id: "registrations",
    ...
    context: "Front office queue stable",
  },
  {
    id: "appointments",
    label: "Appointments",
    value: 128,
    change: "84 checked in",
    tone: "info" as StatusTone,
    context: "18 waiting for doctor",
  },
  {
    id: "waiting",
  ...
  },
  {
    ...
    change: "11 critical",
    tone: "warning" as StatusTone,
    context: "TAT risk in biochemistry",
  },
  {
    id: "pharmacy",
    label: "Rx dispense",
  ...
  },
  {
    ...
    change: "+8.4%",
    tone: "success" as StatusTone,
    context: "Static finance placeholder",
  },
  {
    id: "alerts",
    ...
    context: "Requires acknowledgement",
  },
];
...
export const recentActivity = [
  {
    id: "act-1",
    title: "Critical potassium result acknowledged",
    meta: "Laboratory • 6 min ago",
    tone: "critical" as StatusTone,
  },
  {
    id: "act-2",
    title: "IPD discharge bill moved to review",
    meta: "Billing • 14 min ago",
    tone: "warning" as StatusTone,
  },
  {
    id: "act-3",
    title: "Emergency trauma patient shifted to OT",
    meta: "Emergency • 21 min ago",
    tone: "info" as StatusTone,
  },
  {
    id: "act-4",
    title: "Cardiology queue cleared below threshold",
    meta: "OPD • 32 min ago",
    tone: "success" as StatusTone,
  },
];
...
export const searchResults: SearchResult[] = [
  {
    ...
    type: "Patient",
    title: "Meera Joshi",
    description: "UHID PLH-240118 • 42/F • Cardiology",
    meta: "Last visit today",
    route: "/patients",
  },
  {
    id: "p-2",
    type: "Patient",
    title: "Arjun Kapoor",
    description: "UHID PLH-240076 • 58/M • Orthopedics",
    meta: "IPD active",
    route: "/patients",
  },
  {
    ...
    description: "Cardiology consultant",
    meta: "Available 10:30 AM",
    route: "/opd",
  },
  {
    id: "m-1",
    ...
    description: "Clinical notes, diagnosis, prescription",
    meta: "Phase 5 planned",
    route: "/opd",
  },
  {
    id: "b-1",
    type: "Bill",
    title: "INV-2026-0541",
    description: "Meera Joshi • OPD billing",
    meta: "Partially paid",
    route: "/billing",
  },
  {
    ...
    type: "Lab report",
    title: "LAB-90884",
    description: "Serum potassium • Critical",
    meta: "Needs acknowledgement",
    route: "/laboratory",
  },
  {
    id: "r-1",
