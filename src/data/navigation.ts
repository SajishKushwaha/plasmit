...
export const navigationItems: NavigationItem[] = [
  ...
  },
  {
    ...
    status: "ready",
    children: [
      { id: "head-nurse-patient-dashboard", label: "Patient Dashboard", route: "/nursing-icu/head-nurse?view=patients", status: "ready" },
      { id: "head-nurse-icu-dashboard", label: "ICU Dashboard", route: "/nursing-icu/head-nurse?view=icu", status: "ready" },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      { id: "nursing-icu-head-nurse", label: "Head Nurse", route: "/nursing-icu/head-nurse", status: "ready" },
      { id: "nursing-icu-head-nurse-console", label: "Head Nurse Console", route: "/nursing-icu/head-nurse-console", status: "ready" },
...
export function getNavigationItemsForRole(role: Role): NavigationItem[] {
  ...
  if (role === "ICU") {
    return [
      ...
      {
        id: "icu-admin-discharges",
        label: "Discharge",
        icon: Archive,
        route: "/icu-command-center/patients/discharges",
        group: "Patient Management",
        allowedRoles: ["ICU"],
        status: "ready",
      },
