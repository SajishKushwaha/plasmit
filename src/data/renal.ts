export type RenalStatus =
  "Stable" | "AKI watch" | "Fluid overload" | "Critical" | "Dialysis review";
...
export const mockRenalIntakeEntries: RenalIntakeEntry[] = [
  {
    ...
    ivFluidsMl: 200,
    oralIntakeMl: 60,
    medicationsFlushMl: 20,
    bloodProductsMl: 0,
    enteredBy: "Nisha Thomas",
    status: "Signed",
  },
  {
    id: "rin-002",
  ...
  },
  {
    ...
    ivFluidsMl: 100,
    oralIntakeMl: 220,
    medicationsFlushMl: 0,
    bloodProductsMl: 0,
    enteredBy: "Cardiac nurse",
    status: "Signed",
  },
  {
    id: "rin-017",
...
export const mockRenalDrains: RenalDrainRecord[] = [
  {
    id: "rd-001",
    patientId: "pat-002",
    drainName: "Abdominal drain right",
    site: "Right lower abdomen",
    deviceStatus: "Active",
    currentShiftMl: 280,
    total24HrMl: 280,
    character: "Serous",
    lastCheckedAt: "Today 10:20",
    concern: "None",
  },
  {
    id: "rd-002",
    patientId: "pat-002",
    drainName: "Abdominal drain left",
    site: "Left lower abdomen",
    deviceStatus: "Active",
    currentShiftMl: 180,
    total24HrMl: 180,
  ...
  },
  {
    id: "rd-003",
    patientId: "pat-002",
    drainName: "Chest drain right",
    site: "Right chest",
    deviceStatus: "Active",
    currentShiftMl: 300,
    total24HrMl: 300,
    character: "Serous",
    lastCheckedAt: "Today 09:50",
    concern: "High output",
  },
  {
    id: "rd-004",
    patientId: "pat-002",
    drainName: "Chest drain left",
    site: "Left chest",
    deviceStatus: "Clamp trial",
    currentShiftMl: 150,
    total24HrMl: 150,
    character: "Clear",
    lastCheckedAt: "Today 09:40",
    concern: "Blockage watch",
  },
  {
    id: "rd-005",
    patientId: "pat-002",
    drainName: "NG tube output",
    site: "NG tube",
    deviceStatus: "Active",
    currentShiftMl: 120,
    total24HrMl: 120,
    character: "Bilious",
    lastCheckedAt: "Today 09:30",
    concern: "None",
  },
  {
    id: "rd-006",
    patientId: "pat-002",
    drainName: "Gastrostomy output",
    site: "Gastrostomy",
    deviceStatus: "Active",
    currentShiftMl: 80,
    total24HrMl: 80,
    character: "Clear",
    lastCheckedAt: "Today 09:15",
    concern: "None",
  },
  {
    id: "rd-007",
    patientId: "pat-002",
    drainName: "Flexi seal",
    site: "Rectal tube",
    deviceStatus: "Active",
    currentShiftMl: 70,
    total24HrMl: 70,
    character: "Liquid stool",
    lastCheckedAt: "Today 09:10",
    concern: "None",
  },
  {
    id: "rd-008",
    patientId: "pat-002",
    drainName: "Pericardial drain",
    site: "Pericardial",
    deviceStatus: "Removed placeholder",
    currentShiftMl: 0,
    total24HrMl: 0,
    character: "Nil",
    lastCheckedAt: "Yesterday 18:00",
    concern: "None",
  },
  {
    id: "rd-009",
    ...
    currentShiftMl: 210,
    total24HrMl: 480,
    character: "Coffee-ground watch",
    lastCheckedAt: "Today 10:45",
    concern: "High output",
  },
  {
    id: "rd-010",
    patientId: "pat-004",
    drainName: "Chest drain",
    site: "Right chest",
    deviceStatus: "Active",
    currentShiftMl: 195,
    total24HrMl: 430,
    character: "Serosanguinous",
    lastCheckedAt: "Today 10:50",
    concern: "Infection watch",
  },
];
...
export const mockRenalAlerts: RenalAlert[] = [
  {
    ...
    patientId: "pat-002",
    severity: "Warning",
    title: "Positive balance above target",
    metric: "+560 ml in 24h",
    threshold: "Target +500 ml",
    owner: "Doctor",
    status: "Open",
  },
  {
    ...
    patientId: "pat-002",
    severity: "Warning",
    title: "Chest drain high output",
    metric: "300 ml",
    threshold: "Review >250 ml",
    owner: "Nurse",
    status: "Acknowledged",
  },
  {
  ...
  },
  {
    ...
    patientId: "pat-001",
    severity: "Info",
    title: "Renal status stable",
    metric: "Creatinine 0.9",
...
export const mockRenalOrders: RenalOrder[] = [
  {
    ...
    target: "1800 ml / 24h",
    orderedBy: "Dr. Mohan Ahluvia",
    orderedAt: "Today 08:45",
    status: "Active",
  },
  {
    id: "rord-002",
    patientId: "pat-002",
    order: "Hourly urine output",
    target: "Escalate if <40 ml/hr",
    orderedBy: "Dr. Aman Verma",
    orderedAt: "Today 09:00",
    status: "Active",
  },
  {
    id: "rord-005",
    patientId: "pat-002",
    order: "Repeat RFT + electrolytes",
    target: "Next sample at 18:00",
    orderedBy: "Dr. Mohan Ahluvia",
    orderedAt: "Today 12:10",
    status: "Pending sign",
  },
  {
    id: "rord-006",
    patientId: "pat-002",
    order: "Strict intake source tagging",
    target: "Separate IV, oral, flush, blood products",
    orderedBy: "Dr. Aman Verma",
    orderedAt: "Today 12:20",
    status: "Active",
  },
  {
    id: "rord-007",
    patientId: "pat-002",
    order: "Potassium watch",
    target: "Notify if K+ >= 5.5 mmol/L",
    orderedBy: "Dr. Mohan Ahluvia",
    orderedAt: "Today 12:25",
    status: "Active",
  },
  {
    id: "rord-003",
    patientId: "pat-004",
    order: "Dialysis review",
    target: "Nephrology bedside review",
    orderedBy: "Emergency Desk",
    orderedAt: "Today 10:52",
    status: "Pending sign",
  },
  {
    id: "rord-004",
    patientId: "pat-004",
    order: "Hyperkalemia protocol",
    target: "Repeat potassium after intervention",
    orderedBy: "Dr. Ritu Menon",
    orderedAt: "Today 10:56",
    status: "Active",
  },
];
...
export const mockDialysisSessions: DialysisSession[] = [
  {
    id: "dia-001",
    patientId: "pat-004",
    sessionNo: "DIA-2026-041",
    modality: "Hemodialysis",
    scheduledAt: "Today 13:00",
    accessSite: "Right IJ catheter",
    ufTargetMl: 1800,
    ufRemovedMl: 0,
    preWeightKg: 68.2,
    postWeightKg: 0,
  ...
  },
  {
    id: "dia-002",
    patientId: "pat-002",
    sessionNo: "DIA-2026-039",
    modality: "SLED placeholder",
    scheduledAt: "Yesterday 19:00",
    accessSite: "Not applicable",
    ufTargetMl: 0,
    ufRemovedMl: 0,
    preWeightKg: 72,
    postWeightKg: 72,
...
export function totalIntake(
  entry: Pick<
    RenalIntakeEntry,
    "ivFluidsMl" | "oralIntakeMl" | "medicationsFlushMl" | "bloodProductsMl"
  >,
) {
  return entry.ivFluidsMl + entry.oralIntakeMl + entry.medicationsFlushMl + entry.bloodProductsMl;
}

export function totalOutput(
  entry: Pick<
    RenalOutputEntry,
    "urineOutputMl" | "drainsOutputMl" | "stoolOtherMl" | "insensibleLossMl"
  >,
) {
  return entry.urineOutputMl + entry.drainsOutputMl + entry.stoolOtherMl + entry.insensibleLossMl;
}

export function sumValues<T>(rows: T[], getValue: (_row: T) => number) {
