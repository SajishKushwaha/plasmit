...
export const icuTasks: IcuTask[] = [
  {
    id: "t-1",
    title: "ABG sample and electrolytes",
    patient: "Bed 405B",
    due: "STAT",
    priority: "STAT",
    status: "Pending",
...
export const icuMeds = [
  {
    ...
    patient: "Bed 407",
    status: "High-risk verification",
    time: "09:15 AM",
    nurseSignature: "Required",
  },
  {
    id: "m-2",
...
export const journeyEvents = [
  {
    time: "08:15",
    user: "RN Sarah Jenkins",
    department: "ICU",
    action: "Shift handover completed",
    remarks: "Incoming nurse accepted care.",
  },
  {
    time: "08:45",
    user: "Lab Unit",
    department: "Laboratory",
    action: "ABG collected",
    remarks: "Results pending validation.",
  },
  {
    time: "09:12",
    user: "Dr. Henderson",
    department: "ICU",
    action: "STAT order placed",
    remarks: "Meropenem 1g IV Q8h.",
  },
  {
    time: "09:28",
    user: "Pharmacy",
    ...
    remarks: "Dispensing from central vault.",
  },
];
