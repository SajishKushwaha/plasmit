...
function FieldLabel({ children, className }: { children: React.ReactNode; className?: string }) {
  return (
    <span
      className={(className ? className + " " : "") + "text-xs font-medium text-muted-foreground"}
    >
      {children}
    </span>
  );
...
const _consultants = ["Dr. Kavita Rao", "Dr. Amit Sharma", "Dr. Priya Patel"];
const _requestingDoctors = [
  "Dr. Kavita Rao",
  "Dr. Amit Sharma",
  "Dr. Priya Patel",
  "Dr. Rahul Verma",
...
function _isWithin24Hours(date: string, time: string) {
  const dateTime = parseDateTime(date, time);
  return dateTime ? dateTime.getTime() - Date.now() < 24 * 60 * 60 * 1000 : false;
}

function _isInPast(date: string, time: string) {
  const dateTime = parseDateTime(date, time);
    ...
    <Drawer
      ...
      footer={
        <div className="flex justify-end gap-2">
          ...
          <Button onClick={() => onOpenChange(false)}>Edit</Button>
        </div>
      }
    >
          ...
          <table className="w-full text-sm">
            <tbody>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">Patient Name</td>
                <td className="py-2 text-foreground">{form.patientName}</td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">UHID</td>
                <td className="py-2 text-foreground">{form.uhid}</td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">Admission No.</td>
                <td className="py-2 text-foreground">{form.admissionNo}</td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">Age / Sex</td>
                <td className="py-2 text-foreground">
                  {form.age} / {form.sex}
                </td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">Ward / Bed</td>
                <td className="py-2 text-foreground">{form.wardBedNo}</td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">Requisitioning Unit</td>
                <td className="py-2 text-foreground">
                  {form.requisitionUnit === "Others"
                    ? form.requisitionUnitOther || "Others"
                    : form.requisitionUnit}
                </td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">Consultant</td>
                <td className="py-2 text-foreground">{form.consultant}</td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">Requesting Doctor</td>
                <td className="py-2 text-foreground">{form.requestingDoctor}</td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">Diagnosis</td>
                <td className="py-2 text-foreground">{form.diagnosis}</td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">Indication Type</td>
                <td className="py-2 text-foreground">{form.indicationType}</td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">
                  Indication for Transfusion
                </td>
                <td className="py-2 text-foreground">{form.indicationForTransfusion || "-"}</td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">Blood Group (ABO)</td>
                <td className="py-2 text-foreground">{form.patientBloodGroup}</td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">Rh</td>
                <td className="py-2 text-foreground">{form.patientRh}</td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">Group + Screen Date</td>
                <td className="py-2 text-foreground">{form.groupScreenDate}</td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">Start Time</td>
                <td className="py-2 text-foreground">{form.startTime || "--:--"}</td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">End Time</td>
                <td className="py-2 text-foreground">{form.endTime || "--:--"}</td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">Hold Time</td>
                <td className="py-2 text-foreground">{form.holdTime || "--:--"}</td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">WBC</td>
                <td className="py-2 text-foreground">{form.wbc}</td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">RBC</td>
                <td className="py-2 text-foreground">{form.rbc}</td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">Hb</td>
                <td className="py-2 text-foreground">{form.hb}</td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">PCV</td>
                <td className="py-2 text-foreground">{form.pcv}</td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">Platelets</td>
                <td className="py-2 text-foreground">{form.platelets}</td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">PT</td>
                <td className="py-2 text-foreground">{form.pt}</td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">PTT</td>
                <td className="py-2 text-foreground">{form.ptt}</td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">Other Labs</td>
                <td className="py-2 text-foreground">{form.otherLabs || "-"}</td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">Previous Transfusion</td>
                <td className="py-2 text-foreground">
                  {form.previousTransfusion}
                  {form.previousTransfusionDetails ? ` — ${form.previousTransfusionDetails}` : ""}
                </td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">Previous Reaction</td>
                <td className="py-2 text-foreground">
                  {form.previousReaction}
                  {form.previousReactionDetails ? ` — ${form.previousReactionDetails}` : ""}
                </td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">Pregnancies</td>
                <td className="py-2 text-foreground">{form.pregnancies}</td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">Miscarriage</td>
                <td className="py-2 text-foreground">{form.miscarriage}</td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">Still Birth</td>
                <td className="py-2 text-foreground">{form.stillBirth}</td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">Erythroblastosis</td>
                <td className="py-2 text-foreground">{form.erythroblastosis}</td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">Antibodies Detected</td>
                <td className="py-2 text-foreground">
                  {form.antibodiesDetected}
                  {form.antibodyNames ? ` — ${form.antibodyNames}` : ""}
                </td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">
                  Blood Group Source / Rh Source
                </td>
                <td className="py-2 text-foreground">
                  {form.bloodGroupSource} / {form.rhGroupSource}
                </td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">Counts Linked</td>
                <td className="py-2 text-foreground">{form.bloodCountsLinked ? "Yes" : "No"}</td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">Group & Hold</td>
                <td className="py-2 text-foreground">{form.groupHoldRequested ? "Yes" : "No"}</td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">Cross Match</td>
                <td className="py-2 text-foreground">
                  {form.crossMatchRequested
                    ? `Yes (${form.crossMatchUnits || "-"} unit${form.crossMatchUnits === "1" ? "" : "s"})`
                    : "No"}
                </td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">Request Type</td>
                <td className="py-2 text-foreground">{form.requestType}</td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">Nature of Emergency</td>
                <td className="py-2 text-foreground">{form.natureOfEmergency || "-"}</td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">
                  Replacement Donors (count)
                </td>
                <td className="py-2 text-foreground">{form.donorsCount}</td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">Consent Explained</td>
                <td className="py-2 text-foreground">{form.consentExplained ? "Yes" : "No"}</td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">Doctor Signature</td>
                <td className="py-2 text-foreground">{form.doctorSignature}</td>
              </tr>
              <tr className="border-t">
                <td className="py-2 font-medium text-muted-foreground">Consent Text</td>
                <td className="py-2 text-foreground">{form.consentText || "-"}</td>
              </tr>
            </tbody>
          </table>
        </div>
                  ...
                  form.selectedProducts.map((p) => (
                    <tr key={p.type} className="border-t">
                      <td className="px-2 py-1">
                        {isOtherProduct(p.type) ? form.productDescription || "Other" : p.type}
                      </td>
                      <td className="px-2 py-1">
                        {isOtherProduct(p.type)
                          ? form.productDescriptionUnit || p.quantity
                          : p.quantity}
                      </td>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="text-left text-xs text-muted-foreground">
                  ...
                  <th className="px-2 py-2">ABO</th>
                  <th className="px-2 py-2">Rh</th>
                </tr>
              </thead>
              <tbody>
                {Array.isArray(form.replacementDonors) && form.replacementDonors.length ? (
                  form.replacementDonors.map((d, idx) => (
                    <tr key={idx} className="border-t">
                      <td className="px-2 py-1">Donor {idx + 1}</td>
                      <td className="px-2 py-1">{d.bloodGroup}</td>
                      <td className="px-2 py-1">{d.rh}</td>
                    </tr>
                  ))
                ) : (
                  <tr>
                    <td colSpan={3} className="px-2 py-1 text-muted-foreground">
                      No replacement donors
                    </td>
                  </tr>
                )}
              </tbody>
...
export function BloodProduct() {
  const [submitted, setSubmitted] = React.useState(false);
  const [_errors, setErrors] = React.useState<string[]>([]);
  ...
  const requiresOtherDescription =
    Array.isArray(form.selectedProducts) &&
    form.selectedProducts.some((p) => isOtherProduct(p.type));
  ...
  const _pregnancyOptions = canHidePregnancyFields ? ["N/A"] : ["Yes", "No"];
  ...
  const validate = () => {
    ...
    if (isSurgery && !form.indicationForTransfusion.trim())
      nextErrors.push("Indication for Transfusion is required when Surgery is selected.");
    if (hasReaction && !form.previousReactionDetails.trim())
      nextErrors.push("Reaction details are required when reaction history is Yes.");
    if (!Array.isArray(form.selectedProducts) || form.selectedProducts.length === 0)
      nextErrors.push("At least one blood product must be selected.");
    if (Array.isArray(form.selectedProducts)) {
      form.selectedProducts.forEach((p, _idx) => {
        if (!Number(p.quantity) || Number(p.quantity) < 1)
          nextErrors.push(`Quantity for ${p.type || "product"} must be a whole number >= 1.`);
      });
    }
    if (requiresOtherDescription && !form.productDescription.trim())
      nextErrors.push(
        "Others/Procedure description is required when Others/Procedure is selected.",
      );
    if (
      requiresOtherDescription &&
      (!form.productDescriptionUnit || Number(form.productDescriptionUnit) < 1)
    )
      nextErrors.push("Units for Others/Procedure must be provided and be >= 1.");
    ...
    if (isOtherRequisitionUnit && !form.requisitionUnitOther.trim())
      nextErrors.push("Requisitioning Unit details are required when Other is selected.");
    if (form.groupScreenDate > todayIso())
      nextErrors.push("Group + Screen date cannot be in the future.");
    if (replacementDonorCount < 0) nextErrors.push("Number of donors must be zero or greater.");
    if (replacementDonorCount > 0) {
      if (replacementDonors.length !== replacementDonorCount)
        nextErrors.push("Donor count must match the number of donor entries provided.");
    ...
    if (isEmergency && !form.natureOfEmergency.trim())
      nextErrors.push("Nature of Emergency is required for Emergency requests.");
    if (hasAntibodies && !form.antibodyNames.trim())
      nextErrors.push("Antibody names are mandatory when antibodies are detected.");
    if (!form.consentExplained)
      nextErrors.push("Consent for transfusion must be confirmed before submission.");
    if (!form.doctorSignature.trim()) nextErrors.push("Doctor signature is required.");
    if (!form.patientBloodGroup.trim() || !form.patientRh.trim())
      nextErrors.push("ABO and Rh blood group must be captured.");
    if (
      form.crossMatchRequested &&
      (!form.crossMatchUnits.trim() || Number(form.crossMatchUnits) < 1)
    )
      nextErrors.push("Cross Match units are required when Cross Match is selected.");
        ...
        <CardContent className="space-y-6">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <label className="space-y-2">
                  ...
                  <Input
                    ...
                    placeholder="Free text or ICD-10 search"
                  />
                </label>
              </div>
            </section>
            ...
            <section className="space-y-3">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="space-y-2">
                  <FieldLabel className="mb-0">Indication Type</FieldLabel>
                  <Input
                    value={form.indicationType}
                    onChange={(event) =>
                      setForm((current) => ({ ...current, indicationType: event.target.value }))
                    }
                  />
                </div>
              </div>
          ...
          <section className="space-y-3">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              <div className="space-y-2">
                <div className="flex items-center gap-3">
                  <FieldLabel className="mb-0">Any Previous Transfusion</FieldLabel>
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-3">
                  <FieldLabel className="mb-0">Any Reaction (to previous transfusion)</FieldLabel>
                  ...
                  <Toggle
                    ...
                    onChange={(checked) =>
                      setForm((current) => ({
                        ...
                        previousReactionDetails: checked ? current.previousReactionDetails : "",
                      }))
                    }
                    label=""
                  />
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-3">
                  <FieldLabel className="mb-0">Antibodies Detected Earlier</FieldLabel>
            ...
            <div className="grid gap-4 sm:grid-cols-4">
              <div className="space-y-2">
                <div className="flex items-center gap-3">
                  <FieldLabel className="mb-0">Any Pregnancies</FieldLabel>
                  <Toggle
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex flex-wrap gap-3">
                      {["Yes", "No", "N/A"].map((option) => (
                        <label
                          key={option}
                          className="flex items-center gap-2 rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground shadow-sm transition hover:bg-surface-muted"
                        >
                          <input
                            type="radio"
                            name="miscarriage"
                            ...
                            onChange={(event) =>
                              setForm((current) => ({
                                ...current,
                                miscarriage: event.target.value,
                              }))
                            }
                          />
                          {option}
                      ...
                      {["Yes", "No", "N/A"].map((option) => (
                        ...
                        >
                          <input
                            ...
                            onChange={(event) =>
                              setForm((current) => ({ ...current, stillBirth: event.target.value }))
                            }
                          />
                          {option}
                        </label>
                        ...
                        >
                          <input
                            ...
                            onChange={(event) =>
                              setForm((current) => ({
                                ...current,
                                erythroblastosis: event.target.value,
                              }))
                            }
                          />
                          {option}
          ...
          <section className="space-y-3">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
              <label className="space-y-2">
                <FieldLabel>Blood Group of Patient - ABO</FieldLabel>
                ...
                <FieldSelect
                  ...
                  onChange={(patientBloodGroup) =>
                    setForm((current) => ({
                      ...current,
                      patientBloodGroup,
                      bloodGroupSource: "manual",
                    }))
                  }
                >
              ...
              <label className="space-y-2">
                <FieldLabel>Group + Screen Done On (Date)</FieldLabel>
                <Input
                  type="date"
                  max={todayIso()}
                  value={form.groupScreenDate}
                  onChange={(event) =>
                    setForm((current) => ({ ...current, groupScreenDate: event.target.value }))
                  }
                />
              </label>
              <label className="space-y-2">
                ...
                <Input
                  readOnly={areBloodCountsLinked}
                  value={form.hb}
                  onChange={(event) =>
                    setForm((current) => ({ ...current, hb: event.target.value }))
                  }
                  placeholder="g/dL"
                />
              </label>
              ...
              <label className="space-y-2">
                <FieldLabel>RBC</FieldLabel>
                <Input
                  readOnly={areBloodCountsLinked}
                  value={form.rbc}
                  onChange={(event) =>
                    setForm((current) => ({ ...current, rbc: event.target.value }))
                  }
                />
              </label>
              <label className="space-y-2">
                <FieldLabel>PCV / Hematocrit</FieldLabel>
                <Input
                  readOnly={areBloodCountsLinked}
                  value={form.pcv}
                  onChange={(event) =>
                    setForm((current) => ({ ...current, pcv: event.target.value }))
                  }
                />
              </label>
              <label className="space-y-2">
                <FieldLabel>Platelet Count</FieldLabel>
                <Input
                  readOnly={areBloodCountsLinked}
                  value={form.platelets}
                  onChange={(event) =>
                    setForm((current) => ({ ...current, platelets: event.target.value }))
                  }
                />
              </label>
              <label className="space-y-2">
                <FieldLabel>PT</FieldLabel>
                <Input
                  readOnly={areBloodCountsLinked}
                  value={form.pt}
                  onChange={(event) =>
              ...
              <label className="space-y-2">
                <FieldLabel>PTT</FieldLabel>
                <Input
                  readOnly={areBloodCountsLinked}
                  value={form.ptt}
                  onChange={(event) =>
                    setForm((current) => ({ ...current, ptt: event.target.value }))
                  }
                />
              </label>
              <label className="space-y-2 sm:col-span-2">
                ...
                <Input
                  value={form.otherLabs}
                  onChange={(event) =>
                    setForm((current) => ({ ...current, otherLabs: event.target.value }))
                  }
                />
                <div className="text-xs text-muted-foreground">
              ...
              <label className="flex items-center gap-2 rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground shadow-sm transition hover:bg-surface-muted">
                <input
                  ...
                  onChange={(event) =>
                    setForm((current) => ({ ...current, groupHoldRequested: event.target.checked }))
                  }
                />
            ...
            <div className="grid gap-4 lg:grid-cols-3">
              <div className="space-y-2 lg:col-span-2">
                ...
                <div className="relative" ref={productsRef}>
                  <button
                    type="button"
                    className="flex w-full items-center justify-between rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground shadow-sm"
                    ...
                    <div className="absolute z-40 mt-1 w-full rounded-md border border-border bg-background p-3 shadow-lg">
                      <div className="space-y-2">
                        {productTypes.map((item) => {
                          const checked =
                            Array.isArray(form.selectedProducts) &&
                            form.selectedProducts.find((p) => p.type === item);
                          return (
                            <label key={item} className="flex items-center gap-2">
                              <input
                                ...
                                onChange={(event) =>
                                  setForm((current) => {
                                    const existing = Array.isArray(current.selectedProducts)
                      ...
                      {form.selectedProducts.map((p) => (
                        ...
                        >
                          {isOtherProduct(p.type) ? (
                            <div className="grid gap-3 md:grid-cols-[2fr_120px_1fr]">
                              ...
                              <Input
                                ...
                                onChange={(event) =>
                                  setForm((current) => ({
                                    ...current,
                                    productDescriptionUnit: event.target.value.replace(
                                      /[^0-9]/g,
                                      "",
                                    ),
                                  }))
                            ...
                            <div className="flex items-center gap-3">
                              <div className="w-2/3 text-sm font-medium text-foreground">
                                {p.type}
                              </div>
                              <Input
                                type="number"
                                    ...
                                    selectedProducts: (current.selectedProducts || []).map((x) =>
                                      x.type === p.type
                                        ? {
                                            ...x,
                                            quantity:
                                              event.target.value.replace(/[^0-9]/g, "") || "1",
                                          }
                                        : x,
                                    ),
                                  }))
          ...
          <section className="space-y-3">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              <label className="space-y-2">
                <FieldLabel>Blood/Blood Products Required on (Date)</FieldLabel>
                <Input
                  type="date"
              ...
              <label className="space-y-2">
                ...
                <Input
                  ...
                  value={form.holdTime}
                  onChange={(event) =>
                    setForm((current) => ({ ...current, holdTime: event.target.value }))
                  }
                />
              </label>
              <label className="space-y-2">
                ...
                <FieldSelect
                  ...
                  onChange={(requestType) => setForm((current) => ({ ...current, requestType }))}
                >
            ...
            {isEmergency ? (
              <div className="grid gap-4 lg:grid-cols-2">
                <label className="space-y-2">
                  ...
                  <Input
                    value={form.natureOfEmergency}
                    onChange={(event) =>
                      setForm((current) => ({ ...current, natureOfEmergency: event.target.value }))
                    }
                    placeholder="Required for Emergency"
                  />
                </label>
                <AlertBanner icon={Clock3} tone="warning" title="Emergency workflow">
                  Emergency request becomes mandatory and routes an urgent notification to the Blood
                  Bank queue.
                </AlertBanner>
              </div>
            ) : isRoutineLeadTimeWarning ? (
              <AlertBanner icon={Clock3} tone="warning" title="Routine lead time warning">
                This routine request is scheduled less than 24 hours ahead. Please confirm that this
                meets local policy.
              </AlertBanner>
            ) : (
          ...
          <section className="space-y-3">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              <label className="space-y-2">
                <FieldLabel>Replacement Donors Provided On (Date)</FieldLabel>
                <Input
                  type="date"
                  value={form.replacementDonorDate}
                  onChange={(event) =>
                    setForm((current) => ({ ...current, replacementDonorDate: event.target.value }))
                  }
                />
              </label>
              <label className="space-y-2">
                <FieldLabel>No. of Donors</FieldLabel>
                <Input
                  type="number"
                  min={0}
                  value={form.donorsCount}
                  onChange={(event) => {
                    const nextValue = event.target.value.replace(/[^0-9]/g, "");
                    const nextCount = nextValue === "" ? 0 : Number(nextValue);
                    setForm((current) => {
                      const existing = Array.isArray(current.replacementDonors)
                        ? current.replacementDonors
                        : [];
                      const nextDonors = Array.from(
                        { length: nextCount },
                        (_, index) => existing[index] ?? { bloodGroup: "A+", rh: "Positive" },
                      );
                      return {
                        ...current,
                        donorsCount: String(nextCount),
            ...
            {hasReplacementDonors ? (
              <div className="grid gap-4 md:grid-cols-3">
                {replacementDonors.map((donor, index) => (
                  <div key={index} className="rounded-md border border-border bg-surface-muted p-3">
                    <div className="grid gap-3">
                          ...
                          onChange={(bloodGroup) =>
                            setForm((current) => {
                              const nextDonors = (current.replacementDonors || []).map(
                                (item, donorIndex) =>
                                  donorIndex === index ? { ...item, bloodGroup } : item,
                              );
                      ...
                      <div className="flex items-center justify-between">
                        <FieldLabel className="mb-0">Donor {index + 1} Rh</FieldLabel>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm font-medium">{donor.rh}</span>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <section className="space-y-3">
            ...
            <div className="grid gap-4 lg:grid-cols-2">
              <div className="flex items-center gap-2">
                <Toggle
                  checked={form.consentExplained}
                  onChange={(consentExplained) =>
                    setForm((current) => ({ ...current, consentExplained }))
                  }
                  label=""
                />
                <span className="text-sm font-medium text-foreground">
                  Consent for Transfusion Explained
                </span>
              </div>
              <label className="space-y-2">
        ...
        <Card className="mt-4 border-success/30 bg-success/10">
          <CardContent className="space-y-2 p-4">
            ...
            <p className="text-sm text-muted-foreground">
              Request submitted successfully for Blood Bank approval at{" "}
              {toDateTime(form.requiredDate, form.startTime, form.endTime, form.holdTime)}.
            </p>
