...
function CommunicationLogTable({
  ...
  onView: (row: CommunicationLog) => void;
  onEdit: (row: CommunicationLog) => void;
}) {
  return (
...
function FollowUpTracker({
  ...
  onComplete: (row: FollowUp) => void;
  onEscalate: (row: FollowUp) => void;
  onView: (row: FollowUp) => void;
}) {
  return (
    <Card className="min-w-0 overflow-hidden">
...
function CommunicationFormModal({
  ...
  onDraft: (draft: CommunicationDraft) => void;
  onClose: () => void;
  onSave: () => void;
}) {
  return (
