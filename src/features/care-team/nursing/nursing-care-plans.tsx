...
function WorklistModal({
  ...
  onClose: () => void;
  onTargetChange: (_updates: Partial<WorklistDetails>) => void;
  onSave: (_target: WorklistTarget) => void;
}) {
...
function WorklistDetailsModal({
  ...
  onClose: () => void;
  onEdit: (_target: WorklistDetailsTarget) => void;
}) {
  return (
    <CenterModal
      open={Boolean(target)}
...
function NoteDetailsModal({
  ...
  onClose: () => void;
  onEdit: (_target: NoteDetailsTarget) => void;
}) {
  return (
    <CenterModal
      open={Boolean(target)}
...
function CustomCarePlanModal({
  ...
  onClose: () => void;
  onSave: (_template: CarePlanTemplate) => void;
}) {
  function updateDraft(update: (_current: CarePlanTemplate) => CarePlanTemplate) {
...
function CarePlanSelectionModal({
  ...
  onClose: () => void;
  onSelect: (_template: CarePlanTemplate) => void;
}) {
...
function DocumentCarePlanTable({
  ...
  onAddCarePlan: (_template: CarePlanTemplate) => void;
  onRemoveCarePlan: (_planId: string) => void;
  onResolveProblem: (_planId: string, _problemId: string, _status: ProblemStatus) => void;
  onProgress: (
    _planId: string,
    _problemId: string,
    _goalId: string,
  ...
  onGoalNote: (_target: NoteTarget) => void;
  onAddTarget: (_target: AddTarget) => void;
  onWorklist: (_target: WorklistTarget) => void;
  onToggleIntervention: (_id: string) => void;
  onClearInterventionCheckbox: (_target: CheckboxClearTarget) => void;
...
export function NursingCarePlansPage() {
  ...
  function updatePlan(planId: string, update: (_plan: DocumentCarePlan) => DocumentCarePlan) {
