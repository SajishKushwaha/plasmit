...
export const assessmentGroups: AssessmentGroup[] = [
  {
    ...
    rows: [
      {
        id: "r2",
        group: "Urine assessment",
        label: "Urine Volume (in ml)",
        fieldType: "Number",
        selectable: "None",
        output: true,
      },
      ...
      },
      {
        id: "r4",
        group: "Urine assessment",
        label: "Unmeasured Urine occurrence",
        fieldType: "Dropdown",
        selectable: "Single",
        options: ["Yes", "No"],
      },
      ...
      },
      {
        ...
        fieldType: "Dropdown",
        selectable: "Multiple",
        options: ["Fruity", "Malodorous", "No odor", "Unable to assess"],
        commentBox: true,
      },
      {
        id: "r8",
        group: "Urine assessment",
        label: "Diaper weight (in ml)",
        fieldType: "Number",
        selectable: "None",
        output: true,
      },
  ...
  },
  {
    ...
    rows: [
      {
        id: "st1",
        group: "Stool assessment",
        label: "Unmeasured stool occurrence",
        fieldType: "Dropdown",
        selectable: "Single",
        options: ["Yes", "No"],
      },
      ...
      },
      {
        ...
        fieldType: "Dropdown",
        selectable: "Single",
        options: ["Smear", "Small", "Medium", "Large", "Unable to assess"],
      },
      {
        id: "st5",
        group: "Stool assessment",
        label: "Stool Appearance",
        fieldType: "Dropdown",
        selectable: "Multiple",
        options: [
          "Formed",
  ...
  },
  {
    ...
    rows: [
      {
        id: "ri4",
        group: "Morse Fall risk assessment",
        label: "History of falling    ri4",
        fieldType: "Dropdown",
        selectable: "Single",
        options: ["Yes=25", "No=0"],
      },
      ...
      },
      {
        id: "ri6",
        group: "Morse Fall risk assessment",
        label: "Ambulatory aids     ri6",
        fieldType: "Dropdown",
        selectable: "Single",
        options: ["None/bed rest/Nurse assist=0", "Crutches/Walker/Cane=15", "Furniture=30"],
      },
      {
        id: "ri7",
        group: "Morse Fall risk assessment",
        label: "Intravanous therepy /heparin / salin lock     ri7",
        fieldType: "Dropdown",
        selectable: "Single",
        options: ["Yes=20", "No=0"],
      },
      {
        id: "ri8",
        group: "Morse Fall risk assessment",
        label: "Gait/Transferring     r8",
        fieldType: "Dropdown",
        selectable: "Single",
        options: ["Normal/Bed rest/Wheel chair=0", "Weak=10", "Impaired=20"],
      },
      {
        id: "ri9",
        group: "Morse Fall risk assessment",
        label: "Mental status     r9",
        fieldType: "Dropdown",
        selectable: "Single",
        options: ["Oriented to own ability=0", "Over estimates/Forgets limitations=15"],
      },
      {
        id: "ri10",
        group: "Morse Fall risk assessment",
        ...
        selectable: "None",
        formula: "ri4+ri5+ri6+ri7+ri8+ri9",
      },
      {
        id: "ri11",
        group: "Morse Fall risk assessment",
        label: "Fall risk Intervention",
        fieldType: "Dropdown",
        selectable: "Single",
        options: [
          "Yellow fall risk band applied",
          "Non-skid socks applied",
          "Falling star sign placed at bedside",
          "Bed in lowest position",
          "Strecher/chair alarm in place",
          "Placed close to nurse station",
        ],
      },
    ],
  },
  {
    ...
    rows: [
      ...
      },
      {
        id: "em2",
        group: "Emesis Assessment",
        label: "Unmeasured Emesis Occurrence",
        fieldType: "Dropdown",
        selectable: "Single",
        options: ["Yes", "No"],
      },
      ...
      },
      {
        id: "em4",
        group: "Emesis Assessment",
        label: "Emesis colour/Appearance",
        fieldType: "Dropdown",
        selectable: "Multiple",
        options: [
          "Black",
  ...
  },
  {
    ...
    rows: [
      {
        id: "adl1",
        group: "Daily living Activities assessment",
        label: "Dominant hand",
        fieldType: "Dropdown",
        selectable: "Single",
        options: ["Right", "Left"],
      },
      {
        ...
        fieldType: "Dropdown",
        selectable: "Single",
        options: ["Independent", "Needs assistant", "Dependent", "Unable to assess"],
      },
      {
        id: "adl3",
        group: "Daily living Activities assessment",
      ...
      },
      {
        id: "adl8",
        group: "Daily living Activities assessment",
        label: "Weakness of legs",
        fieldType: "Dropdown",
        selectable: "Single",
        options: ["Right", "Left", "None", "Both", "Unable to assess"],
      },
      {
        id: "adl9",
        group: "Daily living Activities assessment",
  ...
  },
  {
    ...
    rows: [
      {
        id: "br1",
        group: "Braden scale Assessment",
        label: "Sensory perceptions",
        fieldType: "Dropdown",
        selectable: "Single",
      ...
      },
      {
        ...
        fieldType: "Dropdown",
        selectable: "Single",
        options: ["Bed fast", "Chair fast", "Walks occasionally", "Walks frequently"],
      },
      {
        id: "br4",
        group: "Braden scale Assessment",
      ...
      },
      {
        ...
        fieldType: "Calculated",
        selectable: "None",
        formula: "br1+br2+br3+br4+br5+br6",
      },
    ],
  },
  {
    ...
    rows: [
      {
        id: "ox1",
        group: "Oxygen therapy Assessment",
        label: "ETCO2 Level",
        fieldType: "Free text",
        selectable: "None",
      },
      ...
      },
      {
        ...
        fieldType: "Dropdown",
        selectable: "Single",
        options: ["None (Room air)", "High flow nasal canula"],
      },
      {
        id: "ox4",
        group: "Oxygen therapy Assessment",
  ...
  },
  {
    ...
    rows: [
      {
        id: "ng1",
        group: "NG Aspiration assessment",
        label: "Volume (ml)",
        fieldType: "Number",
        selectable: "None",
        output: true,
      },
      {
        ...
        fieldType: "Dropdown",
        selectable: "Multiple",
        options: ["Coffee ground", "Green", "Blood stained", "Clear"],
        commentBox: true,
      },
      {
        id: "ng3",
        ...
        fieldType: "Dropdown",
        selectable: "Multiple",
        options: ["Blood", "Bilious", "Fecal", "Normal"],
        commentBox: true,
      },
    ],
  },
  {
    ...
    rows: [
      {
        id: "neuro1",
        group: "Neuro assessment",
        label: "Pupil size",
        fieldType: "Dropdown",
        selectable: "Single",
        options: ["1 mm", "2 mm", "3 mm", "4 mm", "5 mm", "Unequal", "Unable to assess"],
        commentBox: true,
      },
      {
        id: "neuro2",
        ...
        fieldType: "Dropdown",
        selectable: "Single",
        options: ["Brisk", "Sluggish", "Fixed", "Unable to assess"],
        commentBox: true,
      },
      {
        id: "neuro3",
        group: "Neuro assessment",
        label: "Sedation assessment",
        fieldType: "Dropdown",
        selectable: "Single",
        options: [
          "RASS +4 Combative",
      ...
      },
      {
        id: "neuro4",
        group: "Neuro assessment",
        label: "CAM score (Delirium)",
        fieldType: "Dropdown",
        selectable: "Single",
        options: ["Positive", "Negative", "Unable to assess"],
      },
      {
        id: "neuro5",
        group: "Neuro assessment",
    ...
    rows: [
      {
        ...
        fieldType: "Dropdown",
        selectable: "Single",
        options: ["Symmetrical", "Asymmetrical", "Unable to assess"],
        commentBox: true,
      },
      {
        id: "resp2",
      ...
      },
      {
        ...
        fieldType: "Dropdown",
        selectable: "Single",
        options: ["Normal", "Mild distress", "Moderate distress", "Severe distress"],
      },
      {
        id: "resp4",
        group: "Respiratory",
    ...
    rows: [
      {
        ...
        fieldType: "Dropdown",
        selectable: "Single",
        options: ["Regular", "Irregular", "Sinus rhythm", "AF", "VT", "Unable to assess"],
        commentBox: true,
      },
      {
        id: "cv2",
      ...
      },
      {
        ...
        fieldType: "Dropdown",
        selectable: "Single",
        options: ["< 2 sec", "2-3 sec", "> 3 sec", "Unable to assess"],
      },
      {
        id: "cv4",
        group: "Cardiovascular",
  ...
  },
  {
    ...
    rows: [
      {
        id: "abd1",
        group: "Abdominal assessment",
        label: "Abdomen",
        fieldType: "Dropdown",
        selectable: "Single",
        options: ["Soft", "Distended", "Tender", "Rigid", "Unable to assess"],
        commentBox: true,
      },
      {
        id: "abd2",
        ...
        fieldType: "Dropdown",
        selectable: "Single",
        options: ["Present", "Absent", "Hypoactive", "Hyperactive", "Unable to assess"],
      },
      {
        id: "abd3",
        group: "Abdominal assessment",
        label: "Hands and legs power",
        fieldType: "Dropdown",
        selectable: "Single",
      ...
      },
      {
        ...
        fieldType: "Dropdown",
        selectable: "Single",
        options: ["Normal", "Hypotonia", "Hypertonia", "Unable to assess"],
      },
    ],
  },
  {
    ...
    rows: [
      ...
      },
      {
        ...
        fieldType: "Dropdown",
        selectable: "Single",
        options: ["Negative", "Trace", "+", "++", "+++", "Unable to assess"],
      },
      {
        id: "met4",
        group: "Metabolic assessment",
        ...
        goals: [
          {
            ...
            interventions: [
              {
                id: "i1",
                name: "Assess pain every 4 hours",
                completed: true,
                worklist: true,
                lastNote: "Pain score documented as 4/10.",
              },
              { id: "i2", name: "Position for comfort", completed: false, worklist: true },
              {
                id: "i3",
                name: "Escalate uncontrolled pain to consultant",
                completed: false,
                worklist: false,
              },
            ],
          },
          {
            ...
            interventions: [
              ...
              {
                id: "i5",
                name: "Check dizziness before mobilization",
                completed: true,
                worklist: false,
              },
            ],
        ...
        goals: [
          {
            ...
            interventions: [
              {
                id: "i6",
                name: "Apply fall risk band",
                completed: true,
                worklist: true,
                lastNote: "Yellow band applied.",
              },
        ...
        goals: [
          {
            ...
            interventions: [
              ...
              {
                id: "i9",
                name: "Notify doctor for low urine output",
                completed: false,
                worklist: false,
              },
            ],
...
export const carePlanProgressNotes = [
  {
    id: "n1",
    time: "21 May 2026 10:30",
    goal: "Pain score below 3/10",
    intervention: "Assess pain every 4 hours",
    note: "Pain score 4/10, patient comfortable after repositioning.",
  },
  {
    id: "n2",
    time: "21 May 2026 11:10",
    goal: "Fall precautions maintained",
    intervention: "Apply fall risk band",
    note: "Yellow band applied and education provided.",
  },
  {
    id: "n3",
    time: "21 May 2026 12:00",
    goal: "Intake and output documented each shift",
    intervention: "Record urine volume",
    note: "Urine output 350 ml, clear yellow.",
  },
];
