...
export function BloodRequestTab() {
  ...
  const _isBloodGroupLabVerified = form.bloodGroupSource === "lab";
  const _isRhLabVerified = form.rhGroupSource === "lab";
  ...
  const _isRoutineLeadTimeWarning =
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full rounded-md border border-input px-3 py-2 text-sm text-foreground shadow-sm"
                />
