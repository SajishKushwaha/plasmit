...
export const orderCategories: DrugCategory[] = [
  "Scheduled",
  "SOS",
  "STAT",
  "Bolus",
...
export const doseUnits: DoseUnit[] = [
  "mg",
  "ml",
  "microgram",
  "g",
...
export const initialOrders: DrugOrder[] = [
  ...
  },
  {
    ...
    receivedQty: 0,
    administeredQty: 0,
    diluents: ["Normal Saline", "Dextrose"],
  },
  {
    id: "drug-005",
    category: "Scheduled",
  ...
  },
  {
    id: "drug-007",
    category: "Scheduled",
    genericName: "Prednisolone optho eye drops",
    ...
    route: "Eye",
    availableQty: 18,
    pharmacy: "Outpatient pharmacy 1",
    startDate: "2026-06-05",
    endDate: "",
    instructions: "Drops in eye",
    orderedQty: 50,
    dispensedQty: 0,
    receivedQty: 0,
    administeredQty: 0,
  ...
  },
  {
    id: "drug-008",
    category: "Scheduled",
    genericName: "Citrizine hydrochloride",
    name: "Cetrizine cold DS",
    form: "Syrup",
    dosage: "5",
    doseUnit: "ml",
    maxDosage: "",
    ...
    route: "Oral",
    availableQty: 21,
    pharmacy: "Outpatient pharmacy 2",
    startDate: "2026-06-05",
    endDate: "",
  ...
  },
  {
    ...
    startDate: "2026-06-05",
    endDate: "",
    instructions: "Continuous infusion with pump monitoring",
    orderedQty: 2400,
    dispensedQty: 0,
    receivedQty: 0,
    administeredQty: 0,
