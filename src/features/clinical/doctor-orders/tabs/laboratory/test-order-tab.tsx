...
function SelectField({
  ...
  value: LaboratoryPriority;
  onChange: (_value: LaboratoryPriority) => void;
  options: LaboratoryPriority[];
}) {
  return (
    <select
...
export function LaboratoryTestOrderTab({
  ...
  onDepartmentFilterChange?: (_value: string) => void;
  ...
  sex?: LaboratorySex;
  onSexChange?: (_value: LaboratorySex) => void;
  wardBedNo?: string;
  ...
  onIndicationTypeChange?: (_value: LaboratoryIndicationType) => void;
  ...
  onRequestTypeChange?: (_value: LaboratoryRequestType) => void;
  requiredDate?: string;
  ...
  priority?: LaboratoryPriority;
  onPriorityChange?: (_value: LaboratoryPriority) => void;
  fasting?: boolean;
