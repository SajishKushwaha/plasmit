...
const LDT_CONFIGS: LdtTypeConfig[] = [
  {
    ...
    fields: [
      ...
      {
        id: "locationOfInsertion",
        label: "Location of Insertion",
        type: "text",
        group: "property",
      },
      ...
      {
        id: "placementVerification",
        label: "Placement Verification",
        type: "select",
        group: "property",
        options: optionPairs(["Confirmed", "Pending", "Not Verified"]),
      },
      {
        id: "siteAssessment",
        ...
        type: "multiselect",
        group: "assessment",
        options: optionPairs(["Clean", "Dry", "Intact", "Redness", "Swelling", "Discharge"]),
      },
      {
        id: "ldtStatus",
        label: "LDT Status",
        type: "select",
        group: "assessment",
        options: optionPairs(["Active", "Completed", "On Hold", "Discontinued"]),
      },
      {
        id: "dressingType",
        label: "Dressing Type",
        type: "select",
        group: "assessment",
        options: optionPairs(["Transparent", "Gauze", "Occlusive"]),
      },
      {
        id: "dressingStatus",
        ...
        type: "select",
        group: "assessment",
        options: optionPairs(["Clean", "Changed", "Required", "Dry"]),
      },
    ],
  },
  {
    ...
    fields: [
      ...
      { id: "balloonVolume", label: "Balloon Volume", type: "number", group: "property" },
      {
        ...
        type: "select",
        group: "assessment",
        options: optionPairs(["Clear", "Yellow", "Amber", "Cloudy", "Bloody"]),
      },
      {
        id: "catheterStatus",
        ...
        type: "select",
        group: "assessment",
        options: optionPairs(["Patent", "Blocked", "Leaking", "Removed"]),
      },
    ],
  },
  {
