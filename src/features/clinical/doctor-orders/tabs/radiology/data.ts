...
export const radiologyTestList: RadiologyTest[] = [
  {
    id: "ct-spine-head",
    name: "CT Spine Head",
    description: "Cervical spine head protocol",
    modality: "CT",
    category: "CT Scan",
    code: "28566-8",
    specifications: ["Left", "Right", "Upper", "Lower", "Lateral"],
  },
  {
    id: "ct-head",
    name: "CT Head",
    ...
    category: "CT Scan",
    code: "24725-4",
    specifications: ["Contrast", "Non-contrast"],
  },
  {
    id: "ct-chest",
    name: "CT Chest W/O contrast",
    description: "Chest CT without contrast",
    modality: "CT",
    category: "CT Scan",
    code: "29252-4",
    specifications: ["Axial", "Coronal", "Sagittal"],
  },
  {
    id: "usg-abdomen",
    name: "USG Abdomen",
    ...
    category: "Ultrasound",
    code: "41806-1",
    specifications: ["Upper", "Lower", "Full Abdomen"],
  },
  {
    id: "mri-brain",
    name: "MRI Brain",
    description: "MRI brain with protocol",
    modality: "MRI",
    category: "MRI",
    code: "70551",
    specifications: ["With contrast", "Without contrast"],
  },
  {
    id: "xray-chest",
    name: "Chest X-Ray",
...
export const radiologyTestGroups: RadiologyGroup[] = [
  {
    ...
    name: "CT Scan",
    modality: "CT",
    tests: ["ct-head", "ct-brain", "ct-chest", "ct-spine-head"],
  },
...
export const radiologySummaryRows: RadiologySummaryRow[] = [
  ...
  {
    id: "rad-usg",
    selectedTests: "USG Abdomen",
    loincCode: "41806-1",
    category: "Ultrasound",
    specification: "Whole Abdomen",
    priority: "STAT",
    status: "Completed",
    orderDateTime,
  },
...
export const radiologyResultBlocks: RadiologyResultBlock[] = [
  {
    ...
    rows: [
      ...
      {
        parameter: "Cardiomediastinal silhouette",
        result: "Normal",
        unit: "-",
