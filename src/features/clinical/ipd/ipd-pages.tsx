...
import { ConfirmDrawer, DetailRow, StickyActionBar } from "@/features/operations/admin/admin-shared";
import { PatientMini } from "@/features/operations/appointments/appointment-shared";
import { BedCard, InpatientSafetyPanel, IpdStatus, ProtectedIpd, TriageBadge, type IpdPatientWorkspaceContext } from "@/features/clinical/ipd/ipd-shared";
import { AbdominalDashboardPage, CvsDashboardPage, DrainsOverviewPage, IcuPatientSearchHeader, LinesDevicesOverviewPage } from "@/features/clinical/icu-monitoring/icu-monitoring-pages";
