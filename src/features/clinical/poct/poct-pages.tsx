...
import {
  ...
  type PoctStatus,
  type PoctTest,
} from "@/features/clinical/poct/poct-data";
...
type PoctWorkspaceProps = {
  ...
  onModeChange?: (_mode: PoctWorkspaceMode) => void;
...
function TestPicker({
  ...
  onSearchChange,
  onToggle,
  onAddAnotherTime: _onAddAnotherTime,
  actions,
}: {
...
function DraftCardForm({
  ...
  draft: DraftCard;
  errors?: DraftErrors;
  onChange: (_id: string, _patch: Partial<DraftCard>) => void;
