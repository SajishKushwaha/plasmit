...
import {
  ...
  SectionShell,
  useRenalAccess,
} from "@/features/clinical/renal/renal-shared";
...
function _patientRecordSearchText(patient: (typeof mockPatients)[number]) {
...
function useRenalChartColumns(onOpen: (_chart: RenalPatientChart) => void) {
...
function RenalPriorityQueueTab({
  ...
  onAction: (_action: OverviewActionRequest) => void;
}) {
...
function RenalOverviewPatientList({
  ...
  charts: RenalPatientChart[];
  onReview: (_chart: RenalPatientChart) => void;
  onAction: (_action: OverviewActionRequest) => void;
}) {
...
function RenalReportScopeSelector({
  ...
  onScopeChange: (_scope: "all" | "single" | "selected") => void;
  singlePatientId: string;
  onSinglePatientChange: (_patientId: string) => void;
  selectedPatientIds: string[];
  onSelectedPatientIdsChange: (_patientIds: string[]) => void;
...
function RenalAlertQueue({
  ...
  alerts: RenalAlert[];
  onAction?: (_alert: RenalAlert) => void;
}) {
...
function RoleActionPanel({
  ...
  onSort: (_value: string) => void;
  role: string;
  onAction: (_type: OverviewActionType) => void;
}) {
  return (
    <div className="space-y-3">
      <FilterBar
