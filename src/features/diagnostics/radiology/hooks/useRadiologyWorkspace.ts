...
import { criticalAlerts as seedCriticalAlerts } from "@/features/diagnostics/radiology/data/criticalAlerts";
import { pacsStudies as seedPacsStudies } from "@/features/diagnostics/radiology/data/pacsStudies";
import { radiologyOrders as seedOrders } from "@/features/diagnostics/radiology/data/radiologyOrders";
import { radiologyReports as seedReports } from "@/features/diagnostics/radiology/data/reports";
import { radiologySchedules as seedSchedules } from "@/features/diagnostics/radiology/data/schedules";
...
export function useRadiologyWorkspace() {
  ...
  const commit = useCallback(
    (updater: (current: RadiologyWorkspaceState) => RadiologyWorkspaceState, message?: string) => {
