...
function ResultDetailsDialog({
  ...
  onAckNoteChange: (_value: string) => void;
  onAcknowledge: (_result: ResultRecord) => void;
  onAdvanceLaboratory: (_result: ResultRecord) => void;
  onNotifyCritical: (_result: ResultRecord) => void;
  onOpenChange: (_open: boolean) => void;
  onPrint: (_result: ResultRecord) => void;
  onReleaseLaboratory: (_result: ResultRecord) => void;
  onSetNotice: (_notice: string | null) => void;
  onSetPreviewMode: (_mode: PreviewMode) => void;
  open: boolean;
  previewMode: PreviewMode;
...
function TestHistoryPanel({
  ...
  onClose: () => void;
  onSelect: (_result: ResultRecord) => void;
  selectedId?: string;
  title: string;
  totalCount: number;
}) {
