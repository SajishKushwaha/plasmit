...
export const icuTasks: IcuTask[] = [
  ...
  { id: "task-006", patientId: "icu-005", bedNo: "ICU-T05", patientName: "Ananya Roy", taskType: "Transplant monitoring", title: "Check tacrolimus level and urine trend", priority: "High", dueTime: "30 min", status: "Pending", createdBy: "Transplant ICU protocol", assignedTo: "Ward Nurse Neha", remarks: "Immunosuppression and renal output watch" },
  { id: "task-007", patientId: "icu-006", bedNo: "ICU-R06", patientName: "Irfan Qureshi", taskType: "Respiratory monitoring", title: "Repeat ABG after NIV adjustment", priority: "Critical", dueTime: "Now", status: "Assigned", createdBy: "Duty Doctor", assignedTo: "Ward Nurse Arjun", remarks: "Escalate if CO2 remains high or SpO2 below target" },
];
...
export const icuVitals: IcuVital[] = [
  ...
  { id: "vit-005", patientId: "icu-005", bedNo: "ICU-T05", time: "10:15", temperature: "37.3", pulse: 92, bp: "124/78", respiratoryRate: 18, spo2: 98, oxygenFlow: "Room air", gcs: 15, urineOutput: 85, painScore: 3, nurse: "Ward Nurse Neha", abnormal: false, note: "Post transplant renal output adequate; tacrolimus report awaited" },
  { id: "vit-006", patientId: "icu-006", bedNo: "ICU-R06", time: "10:20", temperature: "37.8", pulse: 118, bp: "138/84", respiratoryRate: 30, spo2: 91, oxygenFlow: "NIV FiO2 45%", gcs: 14, urineOutput: 38, painScore: 4, nurse: "Ward Nurse Arjun", abnormal: true, note: "Respiratory distress; ABG repeat due after NIV adjustment" },
];
...
export const medicationRows: IcuMedication[] = [
  ...
  { id: "mar-005", patientId: "icu-006", bedNo: "ICU-R06", medication: "Nebulized Salbutamol", dose: "2.5 mg", route: "Nebulization", frequency: "4 hourly", scheduledTime: "10:30", actualTime: "-", status: "Due", administeredBy: "Ward Nurse Arjun", doubleVerification: "Not required", reason: "COPD exacerbation bronchodilator plan" },
