...
function WorkflowTabs({
  ...
  onChange: (step: BillingDeskStep) => void;
}) {
  return (
...
function PatientWorkspace({
  ...
  patients: BillingDeskPatient[];
  onSelect: (patient: BillingDeskPatient) => void;
  onRegister: (patient: BillingDeskPatient) => void;
}) {
...
function ReferralWorkspace({
  ...
  activeReferral: BillingReferral;
  onSelect: (referral: BillingReferral) => void;
}) {
...
function AppointmentsWorkspace({
  ...
  patient: BillingDeskPatient;
  onAdd: (service: BillingDeskService) => void;
}) {
...
function PaymentWorkspace({
  ...
  paid: number;
  payments: PaymentLine[];
  onPay: (mode: PaymentLine["mode"], amount: number) => void;
...
function RightSummary({
  ...
  invoices: BillingInvoice[];
  onSaveInvoice: () => void;
  onQuickPay: (mode: PaymentLine["mode"], amount: number) => void;
  onReset: () => void;
}) {
