...
import type { BundleItem } from "@/features/platform/bundle/bundle-types";
  ...
  renderPreview: () => (
    <Tabs defaultValue="overview">
      ...
      <TabsContent value="overview">
        <div className="rounded-md border border-border p-3 text-sm">Summary content</div>
      </TabsContent>
      <TabsContent value="orders">
        <div className="flex flex-wrap gap-2 rounded-md border border-border p-3">
          <Badge tone="warning">3 pending</Badge>
          <Badge tone="success">8 complete</Badge>
        </div>
      </TabsContent>
      <TabsContent value="audit">
        <div className="rounded-md border border-border p-3 text-sm">Audit timeline</div>
      </TabsContent>
    </Tabs>
  ),
};
