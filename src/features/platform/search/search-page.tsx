        ...
        <CardContent className="space-y-4">
          <div className="relative">
            ...
            <Input
              ...
              placeholder="Search by UHID, patient, doctor, module, report, invoice..."
            />
          </div>
          ...
          {showLoadingState ? (
            <div
              ...
              aria-live="polite"
              aria-label="Search loading state"
            >
            ...
            <EmptyState
              ...
              description="Try a UHID, doctor name, module, invoice, or report number."
            />
          ) : (
