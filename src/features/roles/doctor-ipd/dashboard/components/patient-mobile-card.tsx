...
import {
  ...
  bpValue,
  mobilePatientBed,
  mobilePatientNameClass,
  mobilePatientStatus,
  mobilePatientStatusClass,
  mobilePatientUhid,
  patientTone,
...
export function PatientMobileCard({
  ...
  const labBadge =
    patient.hr.tone === "red" || patient.spo2.tone === "red"
      ? 2
      : patient.hr.tone === "orange"
        ? 1
        : undefined;
    ...
    <article className="overflow-hidden rounded-lg border border-[#e5e7eb] bg-white shadow-[0_2px_8px_rgba(15,23,42,0.06)]">
      <div className="flex items-start justify-between gap-3 px-3.5 py-3">
        <div className="min-w-0">
          <Link
            className={cn(
              "block truncate text-base font-extrabold leading-6",
              mobilePatientNameClass(tone),
            )}
