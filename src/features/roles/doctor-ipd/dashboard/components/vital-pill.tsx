...
export function MobileVitalBadge({
  label,
  onClick,
  value,
  tone,
  ...
  return (
    <button
      className="flex min-w-0 flex-col items-center gap-1.5 rounded-md outline-none transition active:scale-95 focus-visible:ring-2 focus-visible:ring-blue-300"
      onClick={onClick}
      type="button"
    >
