      ...
      <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain p-3 sm:p-4">
                ...
                >
                  ...
                  <td
                    className={cn(
                      ...
                      selectedEventIndex === index && "bg-primary/75 text-primary-foreground",
                    )}
                  >
                    {event.name}
                  </td>
        ...
        <div className="mt-3 space-y-2">
          ...
          <div className="min-h-20 rounded-sm bg-[#f3f3f3] p-3 text-sm font-medium text-foreground">
            Comments: Blood pressure going down. Current BP {patient.abps.value}/
            {patient.abpd.value}, HR {patient.hr.value}.
          </div>
        ...
        <div className="mt-5 flex flex-wrap justify-center gap-4">
          <Button
            ...
            type="button"
            onClick={() => setActionStatus(`Actions opened for ${selectedEvent.name}`)}
          >
            Actions
          </Button>
          <Button
            className="min-w-24 bg-primary hover:bg-primary/90"
            type="button"
            onClick={() => setActionStatus(`${selectedEvent.name} validated`)}
          >
            Validate
          </Button>
          <Button
            className="min-w-24 bg-primary hover:bg-primary/90"
            type="button"
            onClick={() => setActionStatus(`${selectedEvent.name} saved`)}
          >
            Save
          </Button>
        </div>
